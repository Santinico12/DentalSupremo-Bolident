...
if (isset($_GET['ajax']) && $_GET['ajax'] === 'get_doctor_agenda') {
    ...
    $msg .= "🏥 *Dental Supremo - Gestión Odontológica*\n\n";
    ...
    <div class="header-card">
        <div class="header-left">
            ...
            <div class="header-title-box">
                ...
                <p>Atención automatizada 24/7 y herramientas de comunicación clínica para Dental Supremo</p>
            </div>
        </div>
    ...
    <div class="agent-grid">
        ...
        <div class="dashboard-card">
            <div class="card-title-box">
                <h3><i class="fab fa-whatsapp" style="color: var(--whatsapp-green);"></i> Conexión WhatsApp Dental Supremo</h3>
...
function getBotApiUrl() {
    var custom = localStorage.getItem('dentalsupremo_bot_url') || localStorage.getItem('dentality_bot_url') || localStorage.getItem('tatianaruiz_bot_url') || localStorage.getItem('dra_bot_url');
