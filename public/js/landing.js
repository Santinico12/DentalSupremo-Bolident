...
function initWhatsAppSimulator() {
        ...
        btn.addEventListener('click', async () => {
            ...
            if (scenarioKey === 'agendar') {
                ...
                await runSimpleFlow(
                    ...
                    [
                        "✅ ¡Excelente! Tu cita para mañana a las *10:00 am* en *Dental Supremo* ha quedado *CONFIRMADA*. 🎉",
                        "📍 Te esperamos en la clínica *Dental Supremo*. Te recomendamos llegar 5 minutos antes. ¡Será un gusto atenderte! 🦷✨"
                    ]
                );
    ...
    async function runAgendarFlow() {
        ...
        appendMessage('incoming', "¡Hola! 👋✨ Gracias por comunicarte con *Dental Supremo*. Con gusto te ayudo a reservar tu consulta.\n\n¿Me podrías indicar tu *nombre completo*, por favor?");
        scrollChatToBottom();
...
function initModalDemo() {
    ...
    if (demoForm) {
        demoForm.addEventListener('submit', (e) => {
            ...
            const mensajeWa = `¡Hola Dental Supremo! 👋✨ Soy *${doctor}* de la clínica *${clinica}* (${ciudad}). Me gustaría agendar una demostración en vivo de su software y cotizar el *${plan}*. Celular: ${telefono}`;
            const urlWa = `https://wa.me/59172752039?text=${encodeURIComponent(mensajeWa)}`;
