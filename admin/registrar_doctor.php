...
<style>
    ...
    .page-header {
        ...
        border-radius: 12px;
        margin-bottom: 24px;
        box-shadow: 0 4px 15px rgba(107, 29, 73, 0.12);
    }
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div>
                ...
                <p>Administra el equipo odontológico, especialidades médicas y números de contacto de la Clínica Dra. Tatiana Ruiz</p>
            </div>
